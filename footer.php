    ...
    <div class="container mx-auto">
        ...
        <div class="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
            ...
            <div>
                ...
                <h3 class="text-3xl font-semibold mb-5">Newsletter</h3>
                ...
                <form method="POST" class="bg-white shadow-md rounded px-4 py-4 mb-4" accept-charset="UTF-8" action="https://www.aweber.com/scripts/addlead.pl">
                    ...
                    <p class="pb-3 text-purple-800">Preencha o formulário abaixo para receber nossas novidades em seu e-mail. Suas informações <strong>nunca</strong> serão compartilhadas.</p>
